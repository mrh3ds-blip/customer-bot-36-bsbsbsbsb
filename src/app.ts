...
function defaultInstagramSettings(): InstagramSettings {
  ...
  return {
    username: process.env.INSTAGRAM_USERNAME
      ...
      : "@m.r.hassanzade" || (usernameMatch ? "@" + usernameMatch[1] : "ثبت نشده"),
    pageType: raw.includes("Business") ? "Business" : raw.includes("Creator") ? "Creator" : "ثبت نشده",
    metaConnection: flags.includes("connectionGuide") ? "نیازمند اتصال رسمی Meta/API در فاز بعد" : "ثبت نشده",
    ...
    webhookVerifyToken: process.env.INSTAGRAM_VERIFY_TOKEN || "igv_36",
...
function defaultSettings(): Settings {
  return {
    ...
    welcomeMessage: "Snnsnsbsbbs",
    supportContact: "Shannan",
